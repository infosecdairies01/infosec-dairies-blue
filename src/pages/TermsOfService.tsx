  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 pt-32 pb-16">
        <h1 className="text-4xl font-bold text-foreground mb-2">📜 Terms of Service – InfosecDairies</h1>
        <p className="text-sm text-muted-foreground mb-8">Last Updated: 21-01-2026</p>
        
        <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground">
          <p className="text-lg">
            By accessing or using InfosecDairies, you agree to these Terms of Service.
          </p>

          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-foreground">1. Purpose of the Platform</h2>
            <p>InfosecDairies provides:</p>
          ...
          <section className="space-y-4">
            ...
            <p className="mt-2">InfosecDairies is not responsible for misuse of skills outside the platform.</p>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-foreground">4. Intellectual Property</h2>
            <ul className="list-disc pl-6 space-y-1">
              <li>All lab content, dashboards, explanations, and designs belong to InfosecDairies</li>
          ...
          <section className="space-y-4">
            ...
            <p>InfosecDairies is not liable for:</p>
            <ul className="list-disc pl-6 space-y-1">
