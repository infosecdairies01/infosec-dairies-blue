    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 pt-32 pb-16">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground">
          <p className="text-lg">
            The information, labs, and training provided on InfosecDairies are intended strictly for 
          ...
          <section className="space-y-4">
            ...
            <p>InfosecDairies does not encourage, promote, or authorize:</p>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section className="space-y-4">
            ...
            <p>InfosecDairies is not responsible for:</p>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section className="space-y-4">
            ...
            <p>
              While we strive to provide accurate and up-to-date content, InfosecDairies makes no guarantees 
          ...
          <section className="space-y-4">
            ...
            <p>InfosecDairies may contain links to third-party websites. We are not responsible for:</p>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section className="space-y-4">
            ...
            <p>By using InfosecDairies, you acknowledge that:</p>
            <ul className="list-disc pl-6 space-y-1">
