  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 pt-32 pb-16">
        <h1 className="text-4xl font-bold text-foreground mb-2">🔐 Privacy Policy – InfosecDairies</h1>
        <p className="text-sm text-muted-foreground mb-8">Last Updated: 21-01-2026</p>
        
        <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground">
          <p className="text-lg">
            InfosecDairies ("we", "our", "us") values your privacy. This Privacy Policy explains how we collect, 
